    ...
    <div class="container">
        ...
        <div style="text-color:red;">
            ...
            if (isset($_POST['submit'])) {
               ...
               $sql = "INSERT INTO `teacher` (`name`, `email`, `password`, `phn_no`, `gender`) VALUES ('$first_name', '$email', '$password', '$phn', '$gender');";
               ...
               if ($stmt) {
                   ...
                   while ($row = mysqli_fetch_array($stmt_1)) {            
                        echo "<br>";
                        echo "\033 Your UserId is : ".$row['user_id'];
        ...
        <div><a href="t_login.php"><input type="button" value="back" class="btn btn-primary btn-lg col btn-block"></a>
        </div>
    </div>
