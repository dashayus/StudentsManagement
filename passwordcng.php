    ...
    <div class="container">
        <div class="card">
            <div class="card-body px-lg-5 pt-0" id="pad">
                <form action="passwordcng.php" method="post">
                    <br>
                    <br>
                    <br>
                    <div class="md-form">
                    ...
                    <input type="submit" value="change your password" class="btn btn-primary btn-lg col btn-block"
                        ...
                        <?php
                            ...
                            if (isset($_POST['update'])) {
                                ...
                                if (($password_1!=null)&&($password_2!=null)&&($password_1==$password_2)) {
                                    $sql = "UPDATE `student` SET `password` = '$password_1' WHERE `student`.`user_id` = '$id'";
                        ...
                        <br>
                    <a href="home.php"><input type="button" class="btn btn-primary btn-lg col btn-block"
                            value="HOME"></a>
                            <br>
                            <br>
                            <br>
